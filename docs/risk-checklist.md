...
- Auth-scope risk: any ambiguous or failed `/api/auth/me` response must stop boot and preference sync. Only explicit auth-disabled mode may select the local user namespace.
